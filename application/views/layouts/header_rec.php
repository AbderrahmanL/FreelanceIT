...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('foundation/css/rec_space.css'); ?>" >
	<?php  
	if(isset($indice))
	{
		?>
				...
				<nav >
					<div class="menubtn">
						...
						<div class="drop">
							<a href="<?php
							if (isset($id_rec)) {
								echo base_url('index.php/recruteurs/editer/').$id_rec; 
							}
							?>"><div class="item">&nbspEditer</div></a>
							<div class="item">&nbspDésactiver</div>
						</div>
					</div>
					<div class="menubtn">
						<div class="mainitem">
						...
						<div class="drop">
						<a href="<?php echo base_url('index.php/recruteurs'); ?>">
								<div class="item">&nbspMes missions</div>
							</a>
							<a href="<?php echo base_url("index.php/missions/creermission"); ?>">
								<div class="item">&nbspNouvelle mission</div>
							</a>
						</div>
					</div>
					<div class="menubtn">
